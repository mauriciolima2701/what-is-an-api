...
- _GET_ : Receber dados de um Resource.
- _POST_ : Enviar dados ou informações para serem processados por um Resource.
- _PUT_ : Atualizar dados de um Resource.
- _DELETE_ : Deletar um Resource.
